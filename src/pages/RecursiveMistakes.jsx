...
import { recursiveMistakesMarkdown } from '../data/recursiveMistakesData';

const { Title } = Typography;

export default function RecursiveMistakes() {
  const navigate = useNavigate();

  const markdownContent = recursiveMistakesMarkdown;
  const THEME_COLOR = '#00ff88';
  ...
  return (
    <div style={{
      ...
      {/* Decorative Glows (Using Green tone for Recursion theme) */}
      <div style={{
        position: 'fixed',
        top: '10%',
        right: '10%',
        ...
        <div style={{
          ...
          <div className="markdown-container">
            <ReactMarkdown
              ...
              components={{
                h1: ({node, children, ...props}) => <h1 id={generateId(children)} style={{ color: '#00ff88', fontSize: '2.5rem', fontWeight: '900', marginTop: '2rem', marginBottom: '1rem', borderBottom: '1px solid rgba(0, 255, 136, 0.2)', paddingBottom: '10px' }} {...props}>{children}</h1>,
