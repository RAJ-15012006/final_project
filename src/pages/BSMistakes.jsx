...
import { bsMistakesMarkdown } from '../data/bsMistakesData';

const { Title } = Typography;

export default function BSMistakes() {
  const navigate = useNavigate();

  const markdownContent = bsMistakesMarkdown;
  ...
  return (
    <div style={{
      ...
      {/* Decorative Glows (Using Teal tone for BS theme) */}
      <div style={{
        position: 'fixed',
        top: '10%',
        right: '10%',
        ...
        <div style={{
          ...
          <div className="markdown-container">
            <ReactMarkdown
              ...
              components={{
                h1: ({node, children, ...props}) => <h1 id={generateId(children)} style={{ color: '#00e5ff', fontSize: '2.5rem', fontWeight: '900', marginTop: '2rem', marginBottom: '1rem', borderBottom: '1px solid rgba(0, 229, 255, 0.2)', paddingBottom: '10px' }} {...props}>{children}</h1>,
