...
import { arrayStringMistakesMarkdown } from '../data/arrayStringMistakesData';

const { Title } = Typography;

export default function ArrayStringMistakes() {
  const navigate = useNavigate();

  const markdownContent = arrayStringMistakesMarkdown;
  const THEME_COLOR = '#ff00ff';
  ...
  return (
    <div style={{
      ...
      {/* Decorative Glows (Using Pink tone for Array theme) */}
      <div style={{
        position: 'fixed',
        top: '10%',
        right: '10%',
        ...
        <div style={{
          ...
          <div className="markdown-container">
            <ReactMarkdown
              ...
              components={{
                h1: ({node, children, ...props}) => <h1 id={generateId(children)} style={{ color: '#ff00ff', fontSize: '2.5rem', fontWeight: '900', marginTop: '2rem', marginBottom: '1rem', borderBottom: '1px solid rgba(255, 0, 255, 0.2)', paddingBottom: '10px' }} {...props}>{children}</h1>,
