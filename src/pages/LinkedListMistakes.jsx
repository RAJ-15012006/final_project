...
import { linkedListMistakesMarkdown } from '../data/linkedListMistakesData';

const { Title } = Typography;

export default function LinkedListMistakes() {
  const navigate = useNavigate();

  const markdownContent = linkedListMistakesMarkdown;
  ...
  return (
    <div style={{
      ...
      {/* Decorative Glows (Using Red tone for Linked List theme) */}
      <div style={{
        position: 'fixed',
        top: '10%',
        right: '10%',
        ...
        <div style={{
          ...
          <div className="markdown-container">
            <ReactMarkdown
              ...
              components={{
                h1: ({node, children, ...props}) => <h1 id={generateId(children)} style={{ color: '#ff4d4f', fontSize: '2.5rem', fontWeight: '900', marginTop: '2rem', marginBottom: '1rem', borderBottom: '1px solid rgba(255, 77, 79, 0.2)', paddingBottom: '10px' }} {...props}>{children}</h1>,
