...
<style>
  @page {
    size: letter;
    margin: 0.52in 0.46in 0.52in 0.46in;
  }
  * {
...
<div class="columns-container">
  ...
  <p>
    JARVIS is designed as a decoupled four-tier system to ensure maintainability, low response latency, and seamless state synchronization. Fig. 1 illustrates the modular structural decomposition and dataflow pathways of the complete system.
  </p>

  <!-- FIGURE 1 (Report Architecture Diagram) -->
  <div class="figure-box">
    <img src="figures/fig_arch_uml.png" alt="System Architecture Diagram" class="figure-img" />
    <div class="figure-caption">Fig. 1. Modular System Architecture and Multi-Tier Decomposition: (a) Architecture Overview, (b) AI Assistant Building Blocks, (c) Simulation & Content Management Layers, (d) RAG System Design Workflow.</div>
  </div>
  ...
  <p>
    To prevent premature solution exposure, JARVIS enforces a 5-level hint hierarchy. Each stage focuses on a specific aspect of the problem-solving workflow. Fig. 2 details the AI pipeline and inference workflow.
  </p>

  <!-- FIGURE 2 (Report AI Pipeline Diagram) -->
  <div class="figure-box">
    <img src="figures/fig_ai_pipeline.png" alt="AI Pipeline Workflow" class="figure-img" />
    <div class="figure-caption">Fig. 2. Socratic AI & RAG Inference Workflow: (a) Prompt Process Pipeline, (b) ETL Ingestion Subsystem, (c) Concrete Model Runtime, (d) RAG Knowledge Query & Response Generation.</div>
  </div>
...
with open('paper/ieee_paper.html', 'w', encoding='utf-8') as f:
    f.write(html)
print('Updated paper/ieee_paper.html with image figures successfully, size:', len(html))
