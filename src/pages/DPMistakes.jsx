...
import { dpMistakesMarkdown } from '../data/dpMistakesData';

const { Title } = Typography;

export default function DPMistakes() {
  const navigate = useNavigate();

  const markdownContent = dpMistakesMarkdown;
  const THEME_COLOR = '#bc13fe';
  ...
  return (
    <div style={{
      ...
      {/* Decorative Glows (Using Purple tone for DP theme) */}
      <div style={{
        position: 'fixed',
        top: '10%',
        right: '10%',
        ...
        <div style={{
          ...
          <div className="markdown-container">
            <ReactMarkdown
              ...
              components={{
                h1: ({node, children, ...props}) => <h1 id={generateId(children)} style={{ color: '#bc13fe', fontSize: '2.5rem', fontWeight: '900', marginTop: '2rem', marginBottom: '1rem', borderBottom: '1px solid rgba(188,19,254,0.2)', paddingBottom: '10px' }} {...props}>{children}</h1>,
